...
def main():
    ...
    local_rank = int(os.environ['SLURM_LOCALID'])  # Identique à SLURM_PROCID
    ...
    os.environ['MASTER_PORT'] = '12345'  # Port arbitraire
    ...
    print(f"Hello from rank {rank} of {world_size} (local rank: {local_rank})")
